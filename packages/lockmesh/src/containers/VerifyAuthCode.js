                ...
                <Form.Item>
                  {this.props.form.getFieldDecorator("verify_code", {
                    ...
                    rules: [
                      {
                        required: true,
                        message: "Please Enter Verification Code to Proceed"
                      },
                      {
                        min: 6,
                        message: "Verification Code must be in 6 digits"
                      }
                    ]
                  })(
                    <Input
                      ...
                      onChange={this.validateVerificationCode}
                    />
                  )}
                </Form.Item>
